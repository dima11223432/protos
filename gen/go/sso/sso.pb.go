...
type LoginRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`
	Passwors      string                 `protobuf:"bytes,2,opt,name=passwors,proto3" json:"passwors,omitempty"`
...
func (x *LoginRequest) GetPasswors() string {
	if x != nil {
		return x.Passwors
	}
	return ""
...
const file_sso_sso_proto_rawDesc = "" +
	"\n" +
	"\rsso/sso.proto\x12\vauthService\"C\n" +
	...
	"\x05email\x18\x01 \x01(\tR\x05email\x12\x1a\n" +
	"\bpasswors\x18\x02 \x01(\tR\bpasswors\x12\x15\n" +
	...
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin2\xd5\x01\n" +
	"\x04Auth\x12G\n" +
	"\bRegister\x12\x1c.authService.RegisterRequest\x1a\x1d.authService.RegisterResponse\x12>\n" +
	"\x05Login\x12\x19.authService.LoginRequest\x1a\x1a.authService.LoginResponse\x12D\n" +
	"\aIsAdmin\x12\x1b.authService.IsAdminRequest\x1a\x1c.authService.IsAdminResponseB\x1aZ\x18authService.sso.v1;ssov1b\x06proto3"
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*IsAdminRequest)(nil),   // 4: authService.IsAdminRequest
	(*IsAdminResponse)(nil),  // 5: authService.IsAdminResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	...
	4, // 2: authService.Auth.IsAdmin:input_type -> authService.IsAdminRequest
	...
	5, // 5: authService.Auth.IsAdmin:output_type -> authService.IsAdminResponse
